export const homeObjOne = {
    ...
    imgStart: false,
    img: require('../../images/gambar1.svg').default,
    alt: 'Bank',
    dark: true,
    primary: true,
    darkText: false
...
export const homeObjTwo = {
    ...
    description: 'We have you covered no matter you are located. All you need is an internet connection and a phone or computer.',
    buttonLabel: 'Learn More',
    imgStart: true,
    img: require('../../images/gambar2.svg').default,
    alt: 'Investment',
    dark: false,
    primary: false,
    darkText: true
...
export const homeObjThree = {
    ...
    imgStart: false,
    img: require('../../images/gambar3.svg').default,
    alt: 'Shopping',
    dark: false,
    primary: false,
    darkText: true
